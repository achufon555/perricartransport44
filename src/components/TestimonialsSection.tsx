...
const testimonials = [
  {
    ...
    text: "Absolutely phenomenal service! I moved from Joburg to Cape Town and needed my BMW transported. Open Road Transport picked it up on time, kept me updated throughout, and delivered it in perfect condition. Will definitely use again!",
  ...
  },
  {
    ...
    text: "I bought a car from a dealer in Durban and was nervous about having it transported. Open Road Transport put my mind at ease with constant updates and GPS tracking. The car arrived spotless. Highly recommend!",
  ...
  },
  {
    ...
    text: "As a car dealer, I regularly need to move vehicles between cities. Open Road Transport has been my go-to for 3 years. Great pricing for bulk transport and they always deliver on time. 10/10 service.",
  ...
  },
  {
    ...
    text: "My vintage car was transported in an enclosed trailer with the utmost care. The team was professional, the communication was great, and the delivery was on schedule. Open Road Transport is the best in the business!",
  ...
  },
  {
    ...
    text: "I had to relocate urgently and needed my car moved within 2 days. Open Road Transport made it happen! Super responsive team, fair pricing, and the driver was courteous and professional. Excellent!",
    vehicle: "VW Polo",
    route: "JHB → BFN",
  },
  {
    ...
    text: "Used Open Road Transport to transport my Audi from PE to Joburg. Seamless from start to finish. The online tracking system is brilliant — I watched my car's journey the whole way. 5 stars without question!",
    vehicle: "Audi A4",
    route: "PE → JHB",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Don&apos;t just take our word for it. Here&apos;s what real customers across South Africa say about Open Road Transport.
          </p>
