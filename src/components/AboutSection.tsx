        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden">
              <Image
                ...
                alt="Open Road Transport vehicle transport team beside a loaded car carrier"
                width={600}
                height={450}
                unoptimized
          ...
          >
            ...
            <p className="text-gray-400 text-base leading-relaxed mb-5">
              Founded in 2012, Open Road Transport has grown to become the leading car
